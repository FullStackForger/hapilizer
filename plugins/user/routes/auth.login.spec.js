...
describe('POST /auth/login', () => {
	...
	it('should reply (200) for POST with token', (done) => {
		Suite.server.inject({
			url: '/auth/login',
			method: 'POST',
			payload: {
	...
	it('should reply unauthorised (401) for invalid credentials', (done) => {
		Suite.server.inject({
			url: '/auth/login',
			method: 'POST',
			payload: {
	...
	it('should reply with bad request (400) for missing credentials', (done) => {
